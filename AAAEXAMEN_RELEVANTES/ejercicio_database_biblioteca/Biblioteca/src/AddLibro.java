...
public abstract class AddLibro {
    ...
    public static Libro addLibro(Statement statement) throws SQLException{
        ...
        "INSERT INTO libros (titulo,autor,editorial,ubicacion,isbn,prestado,prestadopor,prestadousuario)" //(nombre),(apellido1),[apellido2],(edad)
        +"VALUES ("+"'" + libroNuevo.titulo+"',"+"'" + libroNuevo.autor+"'," +"'" + libroNuevo.editorial + "', '" + libroNuevo.ubicacion + "'," + "'" + libroNuevo.isbn + "'," + "'" + libroNuevo.prestado +"'," + null +","+ null + ")";

        if (sentenciaSqlBase != "INSERT INTO libros (nombre,apellido1,apellido2,edad) VALUES ()") { // (nombre),(apellido1),[apellido2],(edad)
            ...
            System.out.println("La clave del libro nuevo creado es:" + String.valueOf(generatedKeys.getInt(1))); //del resulset.get...(1) 1 es la columna
