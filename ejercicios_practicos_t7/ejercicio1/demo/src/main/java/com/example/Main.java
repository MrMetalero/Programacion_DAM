...
public class Main {
    public static void main(String[] args) {
        ...
        Pelicula pelicula1 = new Pelicula("Interestellar", "Christopher Nolan", Formato.avi, 190,"Mathew McConaughey","Anne Hathaway");

        Pelicula pelicula2 = new Pelicula("Interestellar", "Christopher Nolan", Formato.avi, 190,"Mathew McConaughey","Anne Hathaway");
