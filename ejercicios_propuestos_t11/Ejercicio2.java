...
public class Ejercicio2 {
    ...
    public static int funcionFibonacciIterativo(int inputNumber){
        ...
        for(int i = 0; i < inputNumber; i++){
            ...
            numSucessionAnterior2 = numSucessionAnterior1; // meto el valor que antes era el PRIMER ANTERIOR como el SEGUNDO ANTERIOR
            numSucessionAnterior1 = numeroSucesionSiguiente; // meto el valor que antes era el RESULTADO en el PRIMER ANTERIOR
    ...
    public static int funcionRecursivaFibonacci(int limiteFibonacci, int numeroIzquierda2, int numeroIzquierda1){
        ...
        // numeroIzquierda2 + numeroIzquierda1 = 1
         numeroIzquierda2 = 0;  numeroIzquierda1 = 1;
        int numeroSiguiente;
        

        if (numeroIzquierda2 + numeroIzquierda1 != 1) {
            
            funcionRecursivaFibonacci()
